...
download_and_extract_2 "${EIGEN_URL}" "${DOWNLOADS_DIR}/eigen"
download_and_extract "${GEMMLOWP_URL}" "${DOWNLOADS_DIR}/gemmlowp"
download_and_extract_2 "${GOOGLETEST_URL}" "${DOWNLOADS_DIR}/googletest"
download_and_extract_2 "${NSYNC_URL}" "${DOWNLOADS_DIR}/nsync"
download_and_extract_2 "${PROTOBUF_URL}" "${DOWNLOADS_DIR}/protobuf"
download_and_extract_2 "${RE2_URL}" "${DOWNLOADS_DIR}/re2"
download_and_extract_2 "${FFT2D_URL}" "${DOWNLOADS_DIR}/fft2d"
download_and_extract "${DOUBLE_CONVERSION_URL}" "${DOWNLOADS_DIR}/double_conversion"
download_and_extract_2 "${ABSL_URL}" "${DOWNLOADS_DIR}/absl"
